...
function getTinybirdTrackerScript(dataRoot, giftLink) {
...
module.exports = async function ghost_head(options) { // eslint-disable-line camelcase
    ...
    try {
        ...
        if (settingsHelpers.isWebAnalyticsEnabled()) {
            ...
            // data frame (options.data._giftLink) — the same frame ghost_foot
            // reads for the toast — not onto the data root, so read it from there.
            head.push(getTinybirdTrackerScript(dataRoot, options.data._giftLink));
